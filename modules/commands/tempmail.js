...
module.exports.run = async ({
  ...
  if (!_0x57f094[0x0]) {
    _0x49dedf.sendMessage("usage: " + global.config.PREFIX + "tempmail gen\n\nTo get the messages:\n\nuse " + global.config.PREFIX + "tempmail inbox [email]\nexample: " + global.config.PREFIX + "tempmail inbox culyqdbm78o3@kzccv.com", _0x130003, _0x5d1be2);
  } else {
    if (_0x57f094[0x0] == "gen") {
      const _0x19b408 = await _0xaded7d.get("https://markytempmail.cyclic.app/api/gen");
      ...
      if (_0x57f094[0x0] == "inbox") {
        ...
        const _0x482836 = await _0xaded7d.get("https://markytempmail.cyclic.app/api/getmessage/" + _0x34b7f6);
